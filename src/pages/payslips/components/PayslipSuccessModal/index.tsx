...
const PayslipSuccessModal = ({ isOpen, onClose }: Props) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered motionPreset="slideInBottom">
      ...
      >
        ...
        <Text color="textThree" fontSize={["1.125rem", "1.25rem"]} mt={[3]}>
          The payslip task has been added successfully, and a notification has been sent to your
          email.
        </Text>
...
export default PayslipSuccessModal;
