...
} from "@/redux/api/pensionsApiSlice";
...
const Confirm: NextPage = () => {
  ...
  const [cancelRemit, { isLoading: isLoadingCancel, isError: isErrorCancel }] =
    useCancelPensionRemitMutation();
  ...
  return (
    <AuthLayout>
      <SuccessModal isOpen={isOpenSuccess} onClose={handleSuccessClose} data={modalData} />
      <Container maxW="1200" py={[4, 6, 8]}>
        ...
        <Box mt={[6, 8, 10]}>
          <CustomTable data={schedule} columns={scheduleColumns} />
        </Box>
      </Container>
    </AuthLayout>
  );
